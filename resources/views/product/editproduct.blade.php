  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Add Produk<button class="btn btn-outline-success">All Reports</button></h5>
            ...
            <div class="col-lg-6">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="item_produk"  value="{{$p->item_produk}}" required="required">
                </div>
              </div>
              <div class="row mb-3">
                <label class="col-sm-4 col-form-label">Jenis Product  :</label>
                <select name="jenis_produk" class="col-2" value="{{$p->jenis_produk}}" >
              ...
              <div class="row mb-3">
                ...
                <select name="case_produk" class="col-2" value="{{$p->case_produk}}" >
                  <option value="">--Pilih--</option>
              ...
              <div class="row mb-3">
                ...
                <select name="bentuk_produk" class="col-2" value="{{$p->bentuk_produk}}" >
                  <option value="">--Pilih--</option>
              ...
              <div class="row mb-3">
                ...
                <select name="ukuran_produk" class="col-2 dropdown-menu-end" value="{{$p->ukuran_produk}}" >
                  <option value="">--Pilih--</option>
